  ...
  <div>
    ...
    >
      <div class="flex-1 mt-auto mb-4 md:mb-auto">
        <p class="text-steel-500 font-semibold text-4xl">
          {{ illustrator.name }}
        </p>
        <p class="text-steel-500 text-xl">{{ illustrator.jpName }}</p>
      </div>
    </div>
    ...
    >
      <div
        v-for="(novel, index) in illustrator.novels"
        :key="index"
